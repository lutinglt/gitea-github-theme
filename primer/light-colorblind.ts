export default {
  ...
  border: {
    ...
    draft: {
      emphasis: "0.0625rem solid #59636e",
      muted: "0.0625rem solid #d1d9e066",
    },
    attention: {
  ...
  prettylights: {
    syntax: {
      ...
      string: "#0a3069",
      variable: "#953800",
      bracketHighlighterUnmatched: "#762c00",
  ...
  button: {
    ...
    primary: {
      ...
      shadow: {
        selected: "inset 0 1px 0 0 #0021554d",
      },
    },
    invisible: {
      fgColor: {
    ...
    danger: {
      ...
      shadow: {
        selected: "inset 0 1px 0 0 #47170033",
      },
    },
    inactive: {
      fgColor: "#59636e",
